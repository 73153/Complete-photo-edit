...
- (void)setup {
    ...
    NSDictionary *slowFade = @{@"fadeRate": @(VC_LONGEST_STATIC_ANIMATION_PERIOD / 2), @"fadeMagnitude": @1}; // rate: 2/2 sec
    NSDictionary *mediumFade = @{@"fadeRate": @(VC_LONGEST_STATIC_ANIMATION_PERIOD), @"fadeMagnitude": @1}; // rate: 2/4 sec
    NSDictionary *fastFade = @{@"fadeRate": @(VC_LONGEST_STATIC_ANIMATION_PERIOD * 2), @"fadeMagnitude": @1}; // rate: 2/8 sec
    NSArray *fadeSection = @[slowFade, mediumFade, fastFade];
    
    _sections = @[blinkSection, jitterSection, pulseSection, rotateSection, wobbleSection, fadeSection];
