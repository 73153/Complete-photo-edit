    ...
    dispatch_once(&onceToken, ^{
        d =     @{
                  @"noFilter": ^(FilterPickerFilterInfo *noFilter) {
                      ...
                      noFilter.name = NSLocalizedString(@"Original", @"");
                  },
                  ...
                  @"exp": ^(FilterPickerFilterInfo *exp) {
                      ...
                      exp.name = NSLocalizedString(@"Exposure", @"");
                  },
                  @"hue": ^(FilterPickerFilterInfo *hue) {
                      ...
                      hue.name = NSLocalizedString(@"Hue", @"");
                  },
                  ...
                  @"colorize": ^(FilterPickerFilterInfo *colorize) {
                      ...
                      colorize.name = NSLocalizedString(@"Colorize", @"");
                  },
                  @"blur": ^(FilterPickerFilterInfo *blur) {
                      ...
                      blur.name = NSLocalizedString(@"Blur", @"");
                  },
                  @"gradientMap": ^(FilterPickerFilterInfo *gradientMap) {
                      ...
                      gradientMap.name = NSLocalizedString(@"Gradient Map", @"");
                  },
                  @"sharpen": ^(FilterPickerFilterInfo *sharpen) {
                      ...
                      sharpen.name = NSLocalizedString(@"Sharpen", @"");
                  },
                  @"toon": ^(FilterPickerFilterInfo *toon) {
                      ...
                      toon.name = NSLocalizedString(@"Toon", @"");
                  },
                  @"unsharp": ^(FilterPickerFilterInfo *unsharp) {
                      ...
                      unsharp.name = NSLocalizedString(@"Unsharp", @"");
                  },
                  @"gamma": ^(FilterPickerFilterInfo *gamma) {
                      ...
                      gamma.name = NSLocalizedString(@"Gamma", @"");
                  },
                  @"haze": ^(FilterPickerFilterInfo *haze) {
                      ...
                      haze.name = NSLocalizedString(@"Haze", @"");
                  },
                  @"pixellate":^(FilterPickerFilterInfo *pixellate) {
                      ...
                      pixellate.name = NSLocalizedString(@"Pixellate", @"");
                  },
                  @"invert": ^(FilterPickerFilterInfo *invert) {
                      ...
                      invert.name = NSLocalizedString(@"Invert", @"");
                  },
                  @"luminanceThreshold": ^(FilterPickerFilterInfo *luminanceThreshold) {
                      ...
                      luminanceThreshold.name = NSLocalizedString(@"Threshold1", @"");
                  },
                  @"adaptiveThreshold": ^(FilterPickerFilterInfo *adaptiveThreshold) {
                      ...
                      adaptiveThreshold.name = NSLocalizedString(@"Threshold2", @"");
                  },
                  @"avgLuminance": ^(FilterPickerFilterInfo *avgLuminance) {
                      ...
                      avgLuminance.name = NSLocalizedString(@"Threshold3", @"");
                  },
                  @"polarPix": ^(FilterPickerFilterInfo *polarPix) {
                      ...
                      polarPix.name = NSLocalizedString(@"PolarPix", @"");
                  },
                  @"polka": ^(FilterPickerFilterInfo *polka) {
                      ...
                      polka.name = NSLocalizedString(@"Polka", @"");
                  },
                  @"halftone": ^(FilterPickerFilterInfo *halftone) {
                      ...
                      halftone.name = NSLocalizedString(@"Halftone", @"");
                  },
                  @"crosshatch": ^(FilterPickerFilterInfo *crosshatch) {
                      ...
                      crosshatch.name = NSLocalizedString(@"Crosshatch", @"");
                  },
                  @"sobel": ^(FilterPickerFilterInfo *sobel) {
                      ...
                      sobel.name = NSLocalizedString(@"Sobel", @"");
                      // TODO: more props.
                  },
                  @"canny": ^(FilterPickerFilterInfo *canny) {
                      ...
                      canny.name = NSLocalizedString(@"Canny", @"");
                      // TODO
                  },
                  ...
                  @"post": ^(FilterPickerFilterInfo *post) {
                      ...
                      post.name = NSLocalizedString(@"Posterize", @"");
                  },
                  @"emboss": ^(FilterPickerFilterInfo *emboss) {
                      ...
                      emboss.name = NSLocalizedString(@"Emboss", @"");
                  },
                  @"kuwuhara": ^(FilterPickerFilterInfo *kuwuhara) {
                      ...
                      kuwuhara.name = NSLocalizedString(@"Kuwuhara", @"");
                  },
                  @"vignette": ^(FilterPickerFilterInfo *vignette) {
                      ...
                      vignette.name = NSLocalizedString(@"Vignette", @"");
                      // TODO: more props
                  },
                  @"motion": ^(FilterPickerFilterInfo *motion) {
                      ...
                      motion.name = NSLocalizedString(@"Motion blur", @"");
                  },
                  @"zoom": ^(FilterPickerFilterInfo *zoom) {
                      ...
                      zoom.name = NSLocalizedString(@"Zoom blur", @"");
                  },
                  @"swirl": ^(FilterPickerFilterInfo *swirl) {
                      ...
                      swirl.name = NSLocalizedString(@"Swirl", @"");
                  },
                  @"bulge": ^(FilterPickerFilterInfo *bulge) {
                      ...
                      bulge.name = NSLocalizedString(@"Bulge", @"");
                  },
                  @"pinch": ^(FilterPickerFilterInfo *pinch) {
                      ...
                      pinch.name = NSLocalizedString(@"Pinch", @"");
                  },
